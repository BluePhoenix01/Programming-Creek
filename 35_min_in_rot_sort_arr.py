...
# print(findMinInRotatedSortedArrayBinarySearch([4, 5, 6, 7, 0, 1, 2])) # Output: 0

print(findMinInRotatedSortedArrayRecursive([3, 4, 5, 1, 2]))
print(findMinInRotatedSortedArrayRecursive([4, 5, 6, 7, 0, 1, 2])) # Output: 0